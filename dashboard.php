   ...
   <div class="tab-border-wrapper mb-3 p-2 rounded">
    <ul class="nav nav-tabs" id="dashboardTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
         ...
         <li class="nav-item" role="presentation">
      <button class="nav-link <?php if ($activeTab == 'spendingSummary') echo 'active'; ?>" 
              id="spendingSummary-tab" data-bs-toggle="tab" data-bs-target="#spendingSummary" 
              type="button" role="tab">Spending Summary / Budget Suggestion</button>
    </li>

    <li class="nav-item" role="presentation">
      <button class="nav-link <?php if ($activeTab == 'savingGoal') echo 'active'; ?>" 
              id="savingGoal-tab" data-bs-toggle="tab" data-bs-target="#savingGoal" 
              type="button" role="tab">Saving Goal Assistant</button>
    </li>
    </ul>
...
if (!$monthly_income) {
    ...
    <form method="post" class="mb-4">
        ...
        <input type="text" name="goal" class="form-control" placeholder="e.g., Save ₽5,000 this month" required>
        <button type="submit" name="ask_goal" class="btn btn-primary mt-2">Ask AI</button>
    </form>';
}
